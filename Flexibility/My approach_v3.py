...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Air_"+test_typo+'_'+current_time+"_my_approach_3.csv"
...
model = SAC("MlpPolicy", env, learning_rate=0.0003, batch_size =int(128*time_resolution),  ent_coef=_ent_coef_,learning_starts=3000  ) # ent_coef=0.2
