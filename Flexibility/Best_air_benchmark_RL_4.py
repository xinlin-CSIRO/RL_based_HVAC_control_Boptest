...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\benchmark_rl_4.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(action_0) + ',' + str(action_1) + ',' + str(reward) + ',' + str(thermal_kpi) + ',' + str(energy_usage_kpi) + ',' + str(cost_kpi) + ',' + str(out_door_air) + ',' + str(cool_consumption) + ',' + str(heat_consumption) + ',' + str(fan_consumption) + ',' + str(price) + ',' +  str(all_consumption) + ',' + str(Direct_normal_radiation) + ',' +str(global_radiation) + ','+str(humidity) + ',' +str(location_x) + ',' +str(location_y) + ',' +str(sky_cover) +'\n'
