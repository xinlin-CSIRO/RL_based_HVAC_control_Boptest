...
if(cool_or_heat=='heat'):
    ...
    #benchmark_rl
    benchmark_rl = pd.read_excel(data_source, 'Peak_heat_our_test_new')
    ...
    ax1.plot(indoor_our_approach, label='our method: version-1', color='cyan', linewidth=4)
    ax1.plot(indoor_benchmark_rl, label='our method: version-2', color='green', linewidth=4)
    ...
    labels = ['our method: version-1', 'our method: version-2','Benchmark 1: rule-based' ]
