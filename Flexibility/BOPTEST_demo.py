...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Air_"+test_typo+'_'+current_time+"_my_approach_4.csv"
...
model = SAC.load("sac_v2")

test_steps = int(1*time_resolution*24*(1))
