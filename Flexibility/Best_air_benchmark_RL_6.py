...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\benchmark_rl_6.csv"
f_1 = open(result_learning, "w+")
record='indoor_temp,boundary_0,boundary_1,action_0, action_1,reward, thermal_r, energy_r,themal_kpi,energy_kpi,cost_kpi,outdoor_air,scenario,ref,cool_consumption,heating consumption,fan consumption,price,solar,all_consumption\n'
f_1.write(record)
f_1.close()
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        reward=-(all_consumption+abs(indoor_air_temp-ref))
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(
            ...
            fan_consumption) + ',' + str(price) + ',' + str(solar) + ',' + str(all_consumption) + '\n'
...
# model = DDPG('MlpPolicy', env , learning_rate=0.001)
