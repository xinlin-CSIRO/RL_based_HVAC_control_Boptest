...
from boptestGymEnv import BoptestGymEnv, DiscretizedActionWrapper,BoptestGymEnv_xinlin
...
test_typo='highly_dynamic'#peak_heat_day' #'peak_cool_day' #'typical_heat_day' #'peak_heat_day'
now = datetime.now()
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Air_"+test_typo+'_'+current_time+"_my_approach.csv"
...
counter_x=0
class BoptestGymEnvCustomReward(BoptestGymEnv_xinlin):
...
env = BoptestGymEnvCustomReward(url                   = url,
                                ...
                                step_period = (30/time_resolution) * 60,
                                # warmup_period  = 10*24*3600,
                                scenario='highly_dynamic',#'dynamic',#'highly_dynamic',
