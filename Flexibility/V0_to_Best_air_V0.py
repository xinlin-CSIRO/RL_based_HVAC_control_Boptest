...
from reward_functions_flexibility import reward_function_w_flexibility_,reward_function_w_flexibility_v_1_1,reward_function_w_flexibility_v_1_2,reward_function_w_flexibility_saving_,reward_function_w_flexibility_saving_2,the_one_under_test_outdoor
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\V0_best_air_"+test_typo+'_'+current_time+"_v0.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        R_, r_t, r_e, current_indoor_state, thermal_weight, target, scenario = the_one_under_test_outdoor (low_boundary, up_bundary, indoor_air_temp, cool_consumption, heat_consumption, all_consumption, out_door_air)
        ###############################################################
