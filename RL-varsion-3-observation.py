...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\version_3_DQN_"+current_time+"_realing_rate_0.5.csv"
...
record='indoor air, outdoor air, action, reward, energy reward, thermal reward, current consumption,energy kpi, themal kpi, scenario\n'
f_1.write(record)
f_1.close()
# f_2.write(record)
# f_2.close()
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    def compute_reward(self, action):
        ...
        #     thermal_r=_a_* reward_(diff_real)
        #     scenario = 0
        #
        #
        # elif (indoor_good ==indoor_set_good) and (indoor_set_good==0):
        #     thermal_r= _a_* penality_(diff_set)
        #     scenario = 1
        #
        #
        ...
        result_sting = str(indoor_air_temp) +','+str('out_door_air')+ ','+ str(action_)+','+str(reward)+','+ str('energy_r') + ',' + str(thermal_r) + ',' + str('current_consumption') + ',' +   str(energy_usage_kpi) +','+str(thermal_kpi)+','+str(scenario)+'\n'
