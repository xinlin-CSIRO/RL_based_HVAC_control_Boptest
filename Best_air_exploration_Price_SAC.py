...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\new_reward_SAC_priced_calculated_"+current_time+".csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        # out_door_air = 'not observed' #observations[1] - 273.15
        ...
        R_, r_t,r_e,target,scenario,predicted_price,occupied_period,load_shaping_mode = reward_function_w_flexibility_2  (low_boundary, up_bundary,indoor_air_temp,out_door_air, price,cool_consumption,  heat_consumption, fan_consumption, all_consumption, couption_cooling_3, couption_heating_3, couption_fun_3, couption_all_3)
        ###############################################################
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(
            ...
            thermal_kpi) + ',' + str(energy_usage_kpi) + ',' + str(cost_kpi) + ',' + str(out_door_air) + ',' + str(scenario) + ','  + str(target) + \
                        ',' + str(cool_consumption)  +  ',' + str(heat_consumption)  + ','+str(fan_consumption)+',' + str(price)+',' + str(predicted_price)+','+str(all_consumption)+ '\n'
