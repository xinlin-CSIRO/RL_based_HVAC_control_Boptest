...
from wrapper_xinlin import DiscretizedActionWrapper_xinlin_,ContinuousActionWrapper_xinlin,ContinuousActionWrapper_xinlin_single_action,ContinuousActionWrapper_xinlin_single_action_setpoint
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_Two_rooms_our_method_"+current_time+"_SAC_Feb_2.csv"
...
record='indoor temp,boundary,boundary,action,reward,thermal_r,energy_r,themal kpi,energy kpi,outdoor air,scenario,target,energy usage,thermal_weight\n'
f_1.write(record)
f_1.close()
