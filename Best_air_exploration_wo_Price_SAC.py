...
from reward_function import the_one_under_test_1, the_one_under_test_best_air_1, the_one_under_test_best_air_2, \
    the_one_under_test_best_air_3, the_one_under_test_best_air_price, reward_function_w_flexibility_2, \
    reward_function_w_flexibility_3
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\RL_old_reward_"+current_time+"_A2C_continuous.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        R_, r_t,r_e,target,scenario = the_one_under_test_best_air_2(low_boundary, up_bundary, indoor_air_temp, out_door_air, cool_consumption,
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(
            ...
            thermal_kpi) + ',' + str(energy_usage_kpi) + ',' + str(out_door_air) + ',' + str(scenario) + ','  + str(target) + \
                        ',' + str(cool_consumption)  +  ',' + str(heat_consumption)  + ','+str(fan_consumption)+','+str(Supply_air_mass_flow_rate)+',' + str(0)+',' + str(0)+','+str(all_consumption)+ '\n'
...
# model = SAC("MlpPolicy", env, learning_rate=0.01, batch_size = 24, ent_coef=0.2 )
