...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\indoor_only_"+current_time+"_realing_rate_0.5.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    def compute_reward(self, action):
        ...
        result_sting = str(indoor_air_temp) +','+str(low_boundary)+ ','+ str(up_bundary)+','+str(action_)+','+str(reward)+','+ str('out_door_air') + ',' + str(thermal_r) +  ',' +   str(energy_usage_kpi) +','+str(thermal_kpi)+','+str(scenario)+'\n'
