...
from reward_function import reward_function_w_flexibility_peak_heat,reward_function_w_flexibility_peak_heat_2, reward_function_w_flexibility_peak_heat_3
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_air_"+test_typo+'_'+current_time+"_new_reward.csv"
...
record='indoor_temperature,boundary_0,boundary_1,action_0, action_1,reward, thermal_r, energy_r,themal_kpi,energy_kpi,cost_kpi,outdoor_air,scenario,ref,cool_consumption,heating consumption,fan consumption,price,predicted price,all_consumption\n'
f_1.write(record)
f_1.close()
# f_2.write(record)
# f_2.close()
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        R_, r_t,r_e,target,scenario,predicted_price,normalized_price = reward_function_w_flexibility_peak_heat_3 (low_boundary, up_bundary, indoor_air_temp, out_door_air, price, cool_consumption,heat_consumption, fan_consumption, all_consumption)
        ###############################################################
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(
            ...
            fan_consumption) + ',' + str(price) + ',' + str(predicted_price) + ',' + str(all_consumption) +',' + str(normalized_price) + '\n'
...
model = SAC("MlpPolicy", env, learning_rate=0.001, batch_size =24,  ent_coef=0.1 ) # ent_coef=0.2
