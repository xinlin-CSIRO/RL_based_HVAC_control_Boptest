...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_heat_our_method_"+current_time+"_"+test_scenario+"22.csv"
...
model = SAC("MlpPolicy", env, learning_rate=0.001, batch_size =int(time_resolution*24),  ent_coef=0.1)
