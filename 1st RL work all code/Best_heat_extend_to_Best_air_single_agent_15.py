...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best+heat_to_Best_air_"+test_typo+'_'+current_time+"_15_mins.csv"
...
model = SAC("MlpPolicy", env, learning_rate=0.001, batch_size =96,  ent_coef='auto' ) # ent_coef=0.2


learning_steps=  int(96*100) #learning_steps_()
