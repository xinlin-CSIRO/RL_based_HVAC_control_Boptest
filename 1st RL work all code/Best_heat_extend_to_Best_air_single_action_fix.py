...
from reward_function import reward_function_w_flexibility_peak_heat,the_one_under_test_outdoor, the_one_under_test_outdoor_for_cooling, reward_function_w_flexibility_2,the_one_under_test_outdoor_for_cooling_fixed
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_heat_to_Best_air_"+test_typo+'_'+current_time+"_alpa="+str(alpa)+"_fixed_m=0.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        action_1 = action[0] - 273.15


        # all_consumption = cool_consumption + heat_consumption #+ fan_consumption


        R_, r_t, r_e, current_indoor_state, thermal_weight, target, scenario = the_one_under_test_outdoor_for_cooling_fixed (low_boundary, up_bundary, indoor_air_temp, cool_consumption, out_door_air, alpa)
        ###############################################################
...
model = SAC("MlpPolicy", env, learning_rate=0.001, batch_size =24,  ent_coef=0.3 ) # ent_coef=0.2
