...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_heat_our_method_"+current_time+"_"+test_scenario+".csv"
...
model = SAC("MlpPolicy", env, learning_rate=0.001, batch_size = int(24*time_resolution),  ent_coef=0.3)
days_=50
learning_steps = int(1*time_resolution*24*days_) # (3 weeks--> 5 weeks....)
