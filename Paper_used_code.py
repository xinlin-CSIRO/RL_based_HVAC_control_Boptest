...
from reward_function import the_one_under_test_1
...
from boptestGymEnv import BoptestGymEnv, DiscretizedActionWrapper, DiscretizedActionWrapper_xinlin_
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\wo_F_w_E_"+current_time+"_reward_1.csv"
...
env = BoptestGymEnvCustomReward(url                   = url,
                                ...
                                observations          = {
                                    ...
                                    'reaPHeaPum_y': (0, energy_consumption_up_bond),# energy consumption
                                    'reaTSetCoo_y':(250, 303), # boundries
                                    'reaTSetHea_y':(250, 303), # boundries
...
env = DiscretizedActionWrapper_xinlin_(env, n_bins_act=5)
