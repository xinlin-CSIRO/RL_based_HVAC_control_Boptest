...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    ...
    def compute_reward(self, action):
        ...
        R_, r_t,r_e,target,scenario,predicted_price,occupied_period,load_shaping_mode = reward_function_w_flexibility_3  (low_boundary, up_bundary,indoor_air_temp,out_door_air, price,cool_consumption,  heat_consumption, fan_consumption, all_consumption, couption_cooling_3, couption_heating_3, couption_fun_3, couption_all_3)
        ###############################################################
        ...
        result_sting = str(indoor_air_temp) + ',' + str(low_boundary) + ',' + str(up_bundary) + ',' + str(
            ...
            fan_consumption) + ',' + str(price) + ',' + str(predicted_price) + ',' + str(all_consumption) + '\n'
...
# N = [4, 2]
# env = DiscretizedActionWrapper(env, N)
#
