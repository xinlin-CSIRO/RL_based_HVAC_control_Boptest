...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\Best_air_"+test_typo+'_'+current_time+"_3.csv"
...
record='indoor_temp,boundary_0,boundary_1,action_0, action_1,reward, thermal_r, energy_r,themal_kpi,energy_kpi,cost_kpi,outdoor_air,scenario,ref,cool_consumption,heating consumption,fan consumption,price,predicted price,all_consumption\n'
f_1.write(record)
f_1.close()
# f_2.write(record)
# f_2.close()
