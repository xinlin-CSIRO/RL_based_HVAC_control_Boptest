...
from reward_function import the_one_under_test_1, the_one_under_test_time,the_one_under_test_time_2
...
result_learning = "C:\\Users\\wan397\\OneDrive - CSIRO\\Desktop\\RL_WORK_SUMMARY\\wo_F_w_E_"+current_time+"_set_air_temp_time_2.csv"
...
class BoptestGymEnvCustomReward(BoptestGymEnv):
    def compute_reward(self, action):
        ...
        R_, r_t,r_e, current_indoor_state,wild_boundary,target,weight,scenario, bottom_, head_=the_one_under_test_time_2(low_boundary, up_bundary,indoor_air_temp, current_consumption, energy_couption, out_door_air)
        ###############################################################
